...
async function main() {
    console.log('Updating demo restaurant data...');
    ...
    await prisma.restaurant.update({
        ...
        data: { name: 'Parmar Hotel' }
    });
    console.log('Updated restaurant name to Parmar Hotel');

    // Delete existing orders and order items to avoid foreign key constraints
